...
class DeleteDish extends Component {
	...
	constructor(props) {
		...
		this.doDeleteDish = this.doDeleteDish.bind(this);
	}
    ...
    const { dispatch } = this.props;
		dispatch(dishes.deleteDish(this.props.id));
		this.setState({
			open: false
		})
	}
			...
			<>
				...
				<Dialog open={this.state.open} onClose={this.handleClose} aria-labelledby="form-dialog-title">
					...
					<DialogActions className={this.props.classes.button_align} >
						<Button onClick={this.doDeleteDish} size="large" variant="outlined" className={this.props.classes.button_accent}>実行</Button>
...
export default withStyles(style)(
	connect((state => state))(DeleteDish)
  );